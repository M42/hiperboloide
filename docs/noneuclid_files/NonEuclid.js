...
info[MODE.LINE] = '<b>Instructions:</b> Click on two points within the Poincar&eacute; disk to construct the infinite line that passes through the clicked points.';
info[MODE.CIRCLE] = '<b>Instructions:</b> First click within the Poincar&eacute; disk to define a center point, then on a second point to define the circle\'s radius.';
info[MODE.POINT_FREE] = '<b>Instructions:</b> Plot a point by clicking anywhere within the Poincar&eacute; disk.A point created in this way is a <i>free point</i>, meaning that it is not dependant on any other points or objects and can be moved anywhere within the disk.';
info[MODE.INTERSECTION] = '<b>Instructions:</b> Click on two objects (any combination of Lines, Segments or Circles) to construct the intersection point(s) of the two objects.<br><br>Note: If the selected objects do not currently intersect, then nothing new will display; however, if the objects are later moved so that they do intersect, then the intersection point(s) will be displayed.';
info[MODE.POINT_ON_OBJ] = '<b>Instructions:</b> Click on an object (a line, ray, segment or circle) to construct a point on and bound to that object.<br><br>Once constructed, the point may be moved anywhere on the object.';
info[MODE.MOVE_POINT] = '<b>Instructions:</b> Move a point by click-and-drag. Free points may be dragged anywhere within the Poincar&eacute; disk. Points constructed on an object may be moved along that object. A point constructed as intersection can only be moved by moving the points that change the intersection.<br>';
info[MODE.LABEL] = '<b>Instructions:</b> <em>Add</em> or <em>change</em> a point\'s label: Mouseover the point. While it is highlighted, press an alphabetic key.<br><br><em>Remove</em> a label and <em>delete measurements</em> to that label by pressing the spacebar on a highlighted point.<br><br><em>Move</em> a label by click-and-drag.<br>';
info[MODE.HIDE] = '<b>Instructions:</b> Click on a point, line, ray, segment or circle to hide it.<br>Note: Hiding a point will also hide any measurements to that point in the orange measurements area.<br>';
info[MODE.DELETE] = '<b>Instructions:</b> Click on a point, line, ray, segment or circle to delete it <em>and all objects that depend on it</em>.<br>';
info[MODE.ANIMATE] = '<b>Instructions:</b> Watch as the animation script randomly moves points. Note that objects (lines, segments and circles) in NonEuiclid are dependant on points and move when any point on which they depend moves. The <i>free points</i> can move anywhere in the disk. Points constructed <i>on</i> an object are constrained to that object and points constructed as the <i>intersection</i> of objects can only move as the objects move.<br>';
info[MODE.MEASURE_SEGMENT] = '<b>Instructions:</b> Click any two points to measure the distance (as measured in hyperbolic geometry) between the points. Notice that the shortest distance between any two points is along the line segment between those points. In symbols: &#8739;AB&#8739; &le; &#8739;AC&#8739;+&#8739;CB&#8739; for any points A, B and C.If A, B and C are collinear, then &#8739;AB&#8739; = &#8739;AC&#8739;+&#8739;CB&#8739; <br><br><em>Be aware:</em> Due to rounding, you will see: <em>1.01 + 1.01 = 2.01</em> when the exact numbers are: 1.006 + 1.006 = 2.012 since those particular addends round up while the sum rounds down.<br>';
info[MODE.MEASURE_ANGLE] = '<b>Instructions:</b> Click any three points to measure the angle in degrees with the second point as the vertex and first and last defining the legs of the angle.<br>';
info[MODE.MEASURE_TRIANGLE] = '<b>Instructions:</b> Click any three points to measure a triangle\'s three angles and the length of each side.<br>';
