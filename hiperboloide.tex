...
En la obra \textit{Circle Limit I}, en la figura \ref{limit1} podemos
apreciar una teselación regular del tipo $\{4,6\}$.

\begin{figure}[ht!]
  \centering
  \includegraphics[width=40mm]{./limit1edited.jpeg}
  \caption{Circle Limit I, marcando los cuadrados\label{limit3}}
\end{figure}
