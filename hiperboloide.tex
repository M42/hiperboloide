...
puntos de $\mathbb{H}^2$ pasa una única recta, la correspodiente a la
...
Así clasificamos dos rectas según su intersección en
...
disco unitario y a esos puntos los llamaremos puntos del plano
...
llamarán puntos espaciales. Este es el modelo proyectivo que es muy
...
La proyección de la que hemos hablado antes se hace de la siguiente
